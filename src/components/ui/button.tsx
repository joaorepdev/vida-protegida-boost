  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-smooth focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        cta: "bg-accent text-accent-foreground hover:bg-accent-hover shadow-glow font-semibold",
        hero: "bg-gradient-hero text-primary-foreground hover:shadow-elegant transform hover:scale-105 font-semibold text-base",
        "outline-primary": "border-2 border-primary text-primary bg-transparent hover:bg-primary hover:text-primary-foreground",
        gold: "bg-gradient-accent text-accent-foreground hover:shadow-glow font-semibold",
      },
      size: {
